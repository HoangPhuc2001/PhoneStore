...
public class XemAllSPMoinhatActivity extends AppCompatActivity {
    ...
    private static String URL_ShowSPMN = "http://10.0.2.2:8080/Duan/question/readDSMN.php";
    private static String URL_ShowApple = "http://10.0.2.2:8080/Duan/question/readApple.php";
    private static String URL_ShowXiaomi = "http://10.0.2.2:8080/Duan/question/readXiaomi.php";
    private static String URL_ShowSamsung = "http://10.0.2.2:8080/Duan/question/readSamsung.php";
    private static String URL_ShowOppo = "http://10.0.2.2:8080/Duan/question/readOppo.php";
    private static String URL_ShowHuwei = "http://10.0.2.2:8080/Duan/question/readHuwei.php";
    private static String URL_ShowVivo = "http://10.0.2.2:8080/Duan/question/readVivo.php";
