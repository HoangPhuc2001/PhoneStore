...
public class CardFragment extends Fragment {
    ...
    private static String URL_InsertSP= "http://10.0.2.2:8080/Duan/question/orderStatus%20.php";
    private static String URL_InsertOrderDetail= "http://10.0.2.2:8080/Duan/question/orderDetail.php";
    private static RadioButton radioButton;
    private static List<CardSTT> cardFragmentList;
    private static int idmahoadon=57;
