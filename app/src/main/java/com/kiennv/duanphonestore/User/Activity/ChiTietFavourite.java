...
public class ChiTietFavourite extends AppCompatActivity {
    ...
    private int posion;
    private static String URL_Comment = "http://10.0.2.2:8080/Duan/question/comment.php";
    private static String URL_getComment = "http://10.0.2.2:8080/Duan/question/getComment.php";
