...
public class HomeFragment extends Fragment {
    ...
    private static String URL_ShowSP= "http://10.0.2.2:8080/Duan/question/readDSMN.php";
    private static String URL_ShowSPFavourite= "http://10.0.2.2:8080/Duan/question/readFavourite.php";
